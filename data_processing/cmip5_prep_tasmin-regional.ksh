...
ls $fdirOUT*$rcp*1861-2099.nc
		...
		for fullName in ${modelListEnswusa[@]}; do;
			...
			if [ ! -f $fdirOUT/"tasmin_Amon_"$model"_"$rcp"_1861-2099_global-cor.nc" ]; then	
				...
				cdo -s -b 64 sub $fdirKatieDAYMET/tmean_wusa_1980-1999_daily_latlon_monthly_ymonmean.nc  $fdirOUT/"tasmin_Amon_"$model"_"$rcp"_"$ensemble"_1981-1999-1km-ymonmean.nc" $fdirOUT/"tasmin_Amon_"$model"_"$rcp"_"$ensemble"_1981-1999-1km-cf.nc"
